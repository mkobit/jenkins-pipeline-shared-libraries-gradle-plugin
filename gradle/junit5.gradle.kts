val junitPlatformVersion: String by extra { "1.0.0" }
val junitPlatformGradlePluginVersion: String by extra { "1.0.0" }
val junitJupiterVersion: String by extra { "5.0.0" }
val junitVintageVersion: String by extra { "4.12.0" }
