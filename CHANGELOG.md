...
>
> Note: An OpenRewrite migration recipe was included initially but was removed as it was untested.
...
- OpenRewrite migration recipe `com.mkobit.jenkins.pipelines.MigrateSharedLibraryPlugin010To011` for automated 0.10.x → 0.11.x migration (removed later as untested).
